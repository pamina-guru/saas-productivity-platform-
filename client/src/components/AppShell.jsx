...
export default function AppShell() {
  ...
  const itemActive =
    "bg-purple-600/20 text-white ring-1 ring-purple-500/25 " +
    ...
    <div className="min-h-screen bg-black text-white">
      ...
      <div className="mx-auto w-[min(1200px,calc(100%-28px))] py-8">
        <div className="grid gap-6 lg:grid-cols-[280px_1fr]">
          {/* Sidebar */}
          <aside className="relative overflow-hidden rounded-3xl border border-white/10 bg-black/70 shadow-[0_30px_90px_rgba(0,0,0,0.60)] backdrop-blur-xl">
            {/* glow blobs */}
            ...
            <div className="relative flex h-full min-h-[640px] flex-col p-4">
              ...
              <div className="rounded-2xl border border-white/10 bg-white/[0.03] px-4 py-4">
                <div className="flex items-center gap-3">
                  <div className="h-10 w-10 rounded-2xl bg-purple-600/25 ring-1 ring-purple-500/25 shadow-[0_12px_40px_rgba(124,58,237,0.22)] flex items-center justify-center">
              ...
              <nav className="mt-4 flex flex-col gap-1">
                <NavLink
                  to="/app/dashboard"
                  className={({ isActive }) =>
                    clsx(itemBase, isActive && itemActive)
                  }
                >
                  {/* left active indicator */}
                  <span
                    className={clsx(
                      "absolute left-0 top-2.5 bottom-2.5 w-1 rounded-full transition",
                      "bg-purple-500/0",
                      "group-[.active]:bg-purple-500/80",
                    )}
                  />
